...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/prometheus_flask_exporter-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8772&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/prometheus_flask_exporter-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `prometheus_flask_exporter` can be installed with:

```
conda install prometheus_flask_exporter
```

It is possible to list all of the versions of `prometheus_flask_exporter` available on your platform with:
